<?php
class articulo_descuento extends modeloDAO
{
  ...
  //-------------------------------------------------------------------------
  protected $nombreTabla= 'articulos_descuento';
  ...
  protected function datosTabla( $insertar)
  {
    $datos= array(
      ...
      'descuento'    =>str_replace( ',', '.', $this->precio),//asegurar numero en "sql-ingles"
  ...
  public static function sqlListar( $orden='')
  {
    ...
    //----------
    $sql= 'SELECT * FROM articulos_decuento ORDER BY '.$orden;
    return $sql;
  }//sqlListar
