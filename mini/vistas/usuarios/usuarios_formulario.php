...
<?php if ($modelo !== null) { ?>
    ...
    <tr><th>Login</th><td>
            <input type="text" name="usuarioAcceso[login]" id="usuario_login" maxlength="32"
    ...
    <tr><th>Perfil</th><td>
            <input type="text" name="usuarioAcceso[perfil]" id="usuario_perfil" maxlength="32"
                   value="<?php echo html::encode(  $modelo->perfil);?>"/>
        </td></tr>
    <tr><th>última fecha</th><td>
            <?php
            $modelo->ultima_fecha=date("Y-m-d H:i:s");
            echo html::encode(  $modelo->ultima_fecha);
            ?>
