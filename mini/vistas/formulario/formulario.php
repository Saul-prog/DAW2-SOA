...
<form action="" method="post">
    <div class="hoja">
        <table>
            ...
            vista::generarParcial( 'base_formulario', array( 'modelo'=>$modelo, 'error'=>$error));
            ?>
            <tfoot>
            <tr>
