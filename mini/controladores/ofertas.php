...
class controlador_ofertas extends controlador
{
  ...
  public function accion_inicio(){
    ...
    $pagina=1;
      $lineas= config::get('ofertas.lineas', 12);
      if ($lineas < 1) $lineas= 1;//como minimo se obtiene 1 elemento por pagina.
   // $lineas=basedatos::contar('ofertas');
    //if($lineas>10) $lineas=10;
    $total=10;  
    //Ejecutar acción
  ...
  */
  ...
  //Dar una respuesta
  vista::redirigir( '', array('a'=>'ofertas.ver','p'=>$pagina));
  }//accion_add
